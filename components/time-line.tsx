    ...
    return (
        <div className="flex flex-col justify-center">
            <div className="w-full max-w-3xl mx-auto md:pb-40 md:pt-20">
                {/* Overlay glass container to improve legibility over particles */}
                <div className="bg-black/40 backdrop-blur-md rounded-xl p-6"> 
                    <div className="-my-6 divide-y divide-slate-700">
                        {dataAboutPage.map((data) => (
                            <motion.div key={data.id} className="relative py-6 pl-8 sm:pl-32 group"
                            ...
                            >
                                ...
                                <div className="flex flex-col sm:flex-row items-start mb-1 
                                    ...
                                    <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 text-emerald-300 bg-emerald-900/40 rounded-full">{data.date}</time>
